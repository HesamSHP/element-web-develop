...
console.log("Making webapp directory. SHP");
mkdirp.sync("webapp");

fs.copyFile( 'jitsi_external_api.min.js', './webapp/jitsi_external_api.min.js', (err) => {
  if (err) {
...
console.log("Downloading Jitsi script..... SHP");
